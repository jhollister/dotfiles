...
# Fish completions for pass extensions not included in installed completions
# Must have installed pass with its completions already

# tail
complete -c $PROG -f -A -n '__fish_pass_needs_command' -a tail -d 'Command: tail contents of password file excluding password'
complete -c $PROG -f -A -n '__fish_pass_uses_command tail' -a "(__fish_pass_print_entries)"

# tailedit
complete -c $PROG -f -A -n '__fish_pass_needs_command' -a tailedit -d 'Command: edit contents of password file excluding password'
complete -c $PROG -f -A -n '__fish_pass_uses_command tailedit' -a "(__fish_pass_print_entries)"

# update
complete -c $PROG -f -A -n '__fish_pass_needs_command' -a update -d 'Command: update password'
complete -c $PROG -f -A -n '__fish_pass_uses_command update' -s n -l no-symbols -d 'Do not use special symbols'
complete -c $PROG -f -A -n '__fish_pass_uses_command update' -s c -l clip -d 'Put the password in clipboard'
complete -c $PROG -f -A -n '__fish_pass_uses_command update' -s p -l provide -d 'Provide a password by hand'
complete -c $PROG -f -A -n '__fish_pass_uses_command update' -s l -l length= -d 'Provide a password length'
complete -c $PROG -f -A -n '__fish_pass_uses_command update' -a "(__fish_pass_print_entry_dirs)"
